...
I actually wrote the first song 'lennart-p-1' in high school for an assignment. We recorded this in her basement. She plays the keys and I play guitar, which is why these will be the most dominant instruments. The song has a long build-up using reoccurring themes which eventually harmonize together. The ending is somewhat faster and more aggressive, to create some contrast in the song, to add some spice!

We wrote the second song 'lennart-p-2' together in the basement. It started somewhat as a pop song, but gradually changed to some kind of rock symphony? I like to look at it that way. We wanted to express our skill in the sounds of the instruments and technique in the solo's. We put many hours in this one.

I recommend to listen to the songs while looking at the grams and descpritions. 
...
Thank you for reading! I hope my findings were insightful and interesting. Shout out to my friend Joleine who helped writing the second song and shout out to fellow students who helped me with some issues. 
