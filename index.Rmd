...
I liked how well the similarity-matrices worked to analyse the structure of the songs. Also the novelty functions seemed to point out interesting changes in the songs. Also very interesting that the chroma features of the AI songs didn't seem to be too different from the non-AI songs. 
